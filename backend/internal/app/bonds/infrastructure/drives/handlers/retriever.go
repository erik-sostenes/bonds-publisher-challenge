...
// GetBondsPerUserHandler retrieve bonds posted by a specific user
...
// GetBondsHandler retrieves bonds posted by users
func GetBondsHandler(retriever ports.BondsRetriever) response.HttpHandlerFunc {
	if retriever == nil {
		panic("missing Bonds Retriever dependency")
	}
